...
function FinancePreview() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[720px]">
      <div className="absolute -left-5 top-16 hidden w-44 -rotate-6 rounded-2xl border border-[rgb(var(--cash-paper-rgb)/0.8)] bg-[rgb(var(--cash-paper-rgb)/0.9)] p-3 shadow-[var(--cash-shadow-card)] backdrop-blur sm:block lg:-left-10">
      ...
      <div className="absolute -right-4 bottom-8 z-10 w-48 rotate-3 rounded-2xl border border-[rgb(var(--cash-paper-rgb)/0.8)] bg-[var(--cash-onyx)] p-4 text-white shadow-[var(--cash-shadow-card)] sm:-right-8">
      ...
      <div className="relative overflow-hidden rounded-[28px] border border-[rgb(var(--cash-paper-rgb)/0.9)] bg-[var(--cash-paper)] p-2 shadow-[var(--cash-shadow-preview)] sm:rounded-[36px] sm:p-3">
        <div className="overflow-hidden rounded-[21px] border border-[var(--cash-line)] bg-[var(--cash-mist)] sm:rounded-[28px]">
          <div className="flex items-center justify-between border-b border-[var(--cash-line)] bg-[var(--cash-paper)] px-4 py-3 sm:px-5">
          ...
          <div className="relative aspect-[1.85/1] overflow-hidden bg-[var(--cash-paper)]">
            <Image
              src="/dashboard.png"
      ...
      <div className="absolute -bottom-8 left-8 flex items-center gap-2 rounded-full border border-[rgb(var(--cash-paper-rgb)/0.9)] bg-[rgb(var(--cash-paper-rgb)/0.9)] px-3 py-2 text-[11px] font-semibold text-[var(--cash-ink)] shadow-[var(--cash-shadow-card)] backdrop-blur sm:left-16">
